...
public class TestFragment2 extends Fragment implements BluetoothListener, CameraCaller, TestQuestionCaller2{
	...
	private CountDownTimer appealClockTimer = null;
...
//	private static int soundId;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		appealClock = (TextView) view.findViewById(R.id.appeal_clock);
...
//	}
	...
	private class AppealClockTimer extends CountDownTimer {

		public AppealClockTimer(long x) {
			super(x , 1000);
		}

		@Override
		public void onFinish() {
			appealClock.setVisibility(View.INVISIBLE);
		}
		...
		public void onTick(long millisUntilFinished) {
			...
			int minute = (int)(still/60000);
			int second = (int)(still%60000)/1000;

			String formatStr = "%02d";
			String formatMin = String.format(formatStr, minute);
			String formatSec = String.format(formatStr, second);

			appealClock.setText(formatMin+":"+formatSec);
		}
	}
...
//        this.finish();
	...
	*/
	...
	public void setAppealIcon(){
		...
		if(curTs - _ts >= 1000*60*20 && appealAble > 0)
		...
		if(appealOpen || appealAble > 0){
			...
			appealClockTimer = new AppealClockTimer(curTs - _ts);
		}
		else{
			showAppeal = false;
